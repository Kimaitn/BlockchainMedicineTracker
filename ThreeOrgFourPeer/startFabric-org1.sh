...
if [ "${FABRIC_DEV_MODE}" == "true" ]; then
    ...
    DOCKER_FILE="${DIR}"/composer/docker-compose-org1.yml
fi
...
# Create the channel
docker exec peer0.org1.mat.com peer channel create -o orderer1.mat.com:7050 -c composerchannel -f /etc/hyperledger/configtx/composer-channel.tx
