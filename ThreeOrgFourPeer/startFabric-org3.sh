...
if [ "${FABRIC_DEV_MODE}" == "true" ]; then
    ...
    DOCKER_FILE="${DIR}"/composer/docker-compose-org3.yml
fi
...
docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org1.mat.com/msp" peer2.org1.mat.com peer channel fetch config -o orderer3.mat.com:7050 -c composerchannel
